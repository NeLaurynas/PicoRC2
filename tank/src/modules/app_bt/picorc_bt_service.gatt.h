...
// clang-format off
// tank/src/modules/app_bt/picorc_bt_service.gatt.h generated from tank/src/modules/app_bt/picorc_bt_service.gatt for BTstack
// Keep this checked-in header in sync when the .gatt file is updated.
...
constexpr
#endif
const uint8_t picorc_bt_profile_data[] =
{
    // ATT DB Version
    1,
    ...
    // 0x0003 VALUE CHARACTERISTIC-GAP_DEVICE_NAME - READ -'PicoRC'
    // READ_ANYBODY
    0x0e, 0x00, 0x02, 0x00, 0x03, 0x00, 0x00, 0x2a, 0x50, 0x69, 0x63, 0x6f, 0x52, 0x43,
    ...
    // READ_ANYBODY
    0x18, 0x00, 0x02, 0x00, 0x06, 0x00, 0x2a, 0x2b, 0xed, 0x07, 0x34, 0x63, 0xd2, 0x50, 0xe9, 0xcc, 0xc6, 0x34, 0x1d, 0x89, 0x21, 0x21, 0xe2, 0x2d,
    // Bluepad32 Service
    ...
    // PicoRC Service
    // 0x0023 PRIMARY_SERVICE-F7A4C001-2E2D-4E4B-9F2C-5049434F5243
    0x18, 0x00, 0x02, 0x00, 0x23, 0x00, 0x00, 0x28, 0x43, 0x52, 0x4f, 0x43, 0x49, 0x50, 0x2c, 0x9f, 0x4b, 0x4e, 0x2d, 0x2e, 0x01, 0xc0, 0xa4, 0xf7,
    // PicoRC typed notifications: log, tank telemetry, and system telemetry packets
    // 0x0024 CHARACTERISTIC-F7A4C002-2E2D-4E4B-9F2C-5049434F5243 - NOTIFY | DYNAMIC
    0x1b, 0x00, 0x02, 0x00, 0x24, 0x00, 0x03, 0x28, 0x10, 0x25, 0x00, 0x43, 0x52, 0x4f, 0x43, 0x49, 0x50, 0x2c, 0x9f, 0x4b, 0x4e, 0x2d, 0x2e, 0x02, 0xc0, 0xa4, 0xf7,
    // 0x0025 VALUE CHARACTERISTIC-F7A4C002-2E2D-4E4B-9F2C-5049434F5243 - NOTIFY | DYNAMIC
    //
    0x16, 0x00, 0x00, 0x03, 0x25, 0x00, 0x43, 0x52, 0x4f, 0x43, 0x49, 0x50, 0x2c, 0x9f, 0x4b, 0x4e, 0x2d, 0x2e, 0x02, 0xc0, 0xa4, 0xf7,
    ...
    // 0x0027 PRIMARY_SERVICE-ORG_BLUETOOTH_SERVICE_BATTERY_SERVICE
    0x0a, 0x00, 0x02, 0x00, 0x27, 0x00, 0x00, 0x28, 0x0f, 0x18,
    // 0x0028 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BATTERY_LEVEL - DYNAMIC | READ | NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x28, 0x00, 0x03, 0x28, 0x12, 0x29, 0x00, 0x19, 0x2a,
    // 0x0029 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BATTERY_LEVEL - DYNAMIC | READ | NOTIFY
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x29, 0x00, 0x19, 0x2a,
    ...
    // 0x002b PRIMARY_SERVICE-ORG_BLUETOOTH_SERVICE_DEVICE_INFORMATION
    0x0a, 0x00, 0x02, 0x00, 0x2b, 0x00, 0x00, 0x28, 0x0a, 0x18,
    // 0x002c CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_MANUFACTURER_NAME_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x2c, 0x00, 0x03, 0x28, 0x02, 0x2d, 0x00, 0x29, 0x2a,
    // 0x002d VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_MANUFACTURER_NAME_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x2d, 0x00, 0x29, 0x2a,
    // 0x002e CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_MODEL_NUMBER_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x2e, 0x00, 0x03, 0x28, 0x02, 0x2f, 0x00, 0x24, 0x2a,
    // 0x002f VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_MODEL_NUMBER_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x2f, 0x00, 0x24, 0x2a,
    // 0x0030 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SERIAL_NUMBER_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x30, 0x00, 0x03, 0x28, 0x02, 0x31, 0x00, 0x25, 0x2a,
    // 0x0031 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SERIAL_NUMBER_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x31, 0x00, 0x25, 0x2a,
    // 0x0032 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HARDWARE_REVISION_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x32, 0x00, 0x03, 0x28, 0x02, 0x33, 0x00, 0x27, 0x2a,
    // 0x0033 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HARDWARE_REVISION_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x33, 0x00, 0x27, 0x2a,
    // 0x0034 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_FIRMWARE_REVISION_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x34, 0x00, 0x03, 0x28, 0x02, 0x35, 0x00, 0x26, 0x2a,
    // 0x0035 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_FIRMWARE_REVISION_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x35, 0x00, 0x26, 0x2a,
    // 0x0036 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SOFTWARE_REVISION_STRING - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x36, 0x00, 0x03, 0x28, 0x02, 0x37, 0x00, 0x28, 0x2a,
    // 0x0037 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SOFTWARE_REVISION_STRING - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x37, 0x00, 0x28, 0x2a,
    // 0x0038 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SYSTEM_ID - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x38, 0x00, 0x03, 0x28, 0x02, 0x39, 0x00, 0x23, 0x2a,
    // 0x0039 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_SYSTEM_ID - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x39, 0x00, 0x23, 0x2a,
    // 0x003a CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x3a, 0x00, 0x03, 0x28, 0x02, 0x3b, 0x00, 0x2a, 0x2a,
    // 0x003b VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x3b, 0x00, 0x2a, 0x2a,
    // 0x003c CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_PNP_ID - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x3c, 0x00, 0x03, 0x28, 0x02, 0x3d, 0x00, 0x50, 0x2a,
    // 0x003d VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_PNP_ID - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x3d, 0x00, 0x50, 0x2a,
...
#define ATT_SERVICE_F7A4C001_2E2D_4E4B_9F2C_5049434F5243_START_HANDLE 0x0023
#define ATT_SERVICE_F7A4C001_2E2D_4E4B_9F2C_5049434F5243_END_HANDLE 0x0026
#define ATT_SERVICE_F7A4C001_2E2D_4E4B_9F2C_5049434F5243_01_START_HANDLE 0x0023
#define ATT_SERVICE_F7A4C001_2E2D_4E4B_9F2C_5049434F5243_01_END_HANDLE 0x0026
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_BATTERY_SERVICE_START_HANDLE 0x0027
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_BATTERY_SERVICE_END_HANDLE 0x002a
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_BATTERY_SERVICE_01_START_HANDLE 0x0027
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_BATTERY_SERVICE_01_END_HANDLE 0x002a
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_DEVICE_INFORMATION_START_HANDLE 0x002b
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_DEVICE_INFORMATION_END_HANDLE 0x003d
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_DEVICE_INFORMATION_01_START_HANDLE 0x002b
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_DEVICE_INFORMATION_01_END_HANDLE 0x003d
...
#define ATT_CHARACTERISTIC_F7A4C002_2E2D_4E4B_9F2C_5049434F5243_01_VALUE_HANDLE 0x0025
#define ATT_CHARACTERISTIC_F7A4C002_2E2D_4E4B_9F2C_5049434F5243_01_CLIENT_CONFIGURATION_HANDLE 0x0026
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BATTERY_LEVEL_01_VALUE_HANDLE 0x0029
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BATTERY_LEVEL_01_CLIENT_CONFIGURATION_HANDLE 0x002a
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_MANUFACTURER_NAME_STRING_01_VALUE_HANDLE 0x002d
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_MODEL_NUMBER_STRING_01_VALUE_HANDLE 0x002f
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_SERIAL_NUMBER_STRING_01_VALUE_HANDLE 0x0031
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_HARDWARE_REVISION_STRING_01_VALUE_HANDLE 0x0033
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_FIRMWARE_REVISION_STRING_01_VALUE_HANDLE 0x0035
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_SOFTWARE_REVISION_STRING_01_VALUE_HANDLE 0x0037
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_SYSTEM_ID_01_VALUE_HANDLE 0x0039
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_01_VALUE_HANDLE 0x003b
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_PNP_ID_01_VALUE_HANDLE 0x003d
